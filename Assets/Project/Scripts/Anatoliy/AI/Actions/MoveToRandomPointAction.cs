...
[NodeDescription(name: "MoveToRandomPoint", story: "[EnemyAI] moves to random point", category: "Action", id: "7e8e51831ef6fe53fb091644598f85a0")]
public partial class MoveToRandomPointAction : Action
{
    ...
    private const int _maxSearchAttempts = 1;
    ...
    protected override Status OnUpdate()
    {
        ...
        if (EnemyAI.Value.playerDetected || EnemyAI.Value.isFire)
        {
            if (EnemyAI.Value.agent.isOnNavMesh)
                EnemyAI.Value.agent.ResetPath();
            EnemyAI.Value.isSearching = false;
